...
(function() {
  var CellPainter, LRUCache, PagedAsyncTableData, Promise, ScrollBarProxy, SyncTableData, TableData, TableView, binary_search, closest, cumsum, distance, domReadyPromise, isReady, isReadyCallbacks, smallest_diff_subsequence, _ref,
    _this = this,
  ...
  document.addEventListener("DOMContentLoaded", function() {
    return document.removeEventListener("DOMContentLoaded", arguments.callee);
  });
  ...
  ScrollBarProxy = (function() {
    ...
    ScrollBarProxy.prototype.setScrollXY = function(x, y) {
      var onScrollXY;
      x = Math.max(x, 0);
      x = Math.min(x, this.maxScrollHorizontal);
      y = Math.max(y, 0);
      y = Math.min(y, this.maxScrollVertical);
