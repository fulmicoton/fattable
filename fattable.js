...
(function() {
  "use strict";
  var EventRegister, LRUCache, PagedAsyncTableModel, Painter, Promise, ScrollBarProxy, SyncTableModel, TableModel, TableView, binary_search, bound, closest, cumsum, distance, domReadyPromise, fattable, k, ns, onLoad, smallest_diff_subsequence, v,
    ...
    function ScrollBarProxy(container, headerContainer, W, H, eventRegister) {
      ...
      onMouseWheelHeader = (function(_this) {
        return function(evt) {
          ...
          _ref = getDelta(evt), deltaX = _ref[0], _ = _ref[1];
