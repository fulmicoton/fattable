...
function(){};this.scrollLeft=b;this.scrollTop=a;this.horizontalScrollbar.scrollLeft=b;this.verticalScrollbar.scrollTop=a;this.onScrollXY(b,a);return this.onScrollXY=e};return c}();w=function(){function c(b){var a,e=this;a=b.container;if(null==a)throw"container not specified.";if("string"===typeof a)this.container=document.querySelector(a);else if("object"===typeof a)this.container=a;else throw"Container must be a string or a dom element.";this.readRequiredParameter(b,"painter",new v);this.readRequiredParameter(b,
...
this.cells[e+","+d]=a;for(b=c=-this.nbColsVisible;0>c;b=c+=1)a=document.createElement("div"),this.painter.setupColumnHeader(a),this.columns[b]=a,this.headerViewport.appendChild(a);this.firstVisibleRow=-this.nb_rows_visible;this.lastVisibleRow=-this.nbColsVisible;this.goTo(0,0);this.container.appendChild(this.bodyContainer);this.container.appendChild(this.headerContainer);this.bodyContainer.appendChild(this.bodyViewport);this.refreshAllContent();this.scrollBarProxy=new x(this.bodyContainer,this.W,
this.H);return this.scrollBarProxy.onScrollXY=function(a,b){var c;c=f.visible(a,b);e=c[0];d=c[1];f.goTo(e,d);f.headerViewport.style.left=-a+"px";f.bodyViewport.style.left=-a+"px";f.bodyViewport.style.top=-b+"px";clearTimeout(f.scrollEndTimer);return f.scrollEndTimer=setTimeout(f.refreshAllContent.bind(f),200)}};c.prototype.refreshAllContent=function(){var b,a,e,d,c,f,k,h,l,m=this;f=function(a){return m.data.getHeader(d,function(b){return m.painter.fillColumnHeader(a,b)})};l=[];d=k=this.lastVisibleRow;
for(h=this.lastVisibleRow+this.nbColsVisible;k<h;d=k+=1)a=this.columns[d],f(a),l.push(function(){var a,f,h,k=this;h=[];e=a=this.firstVisibleRow;for(f=this.firstVisibleRow+this.nb_rows_visible;a<f;e=a+=1)c=e+","+d,b=this.cells[c],h.push(function(a){return k.data.getCell(e,d,function(b){a.pending=!1;return k.painter.fillCell(a,b)})}(b));return h}.call(this));return l};c.prototype.goTo=function(b,a){this.headerContainer.style.display="none";this.bodyContainer.style.display="none";this.moveX(a);this.moveY(b);
this.headerContainer.style.display="";return this.bodyContainer.style.display=""};c.prototype.moveX=function(b){var a,c,d,g,f,k,h,l,m,p,s,t,q,n,r,u=this;m=this.firstVisibleRow;s=b-this.lastVisibleRow;if(0!==s){k=Math.min(Math.abs(s),this.nbColsVisible);for(a=q=0;q<k;a=q+=1)for(0<s?(p=this.lastVisibleRow+a,f=b+a+this.nbColsVisible-k):(p=this.lastVisibleRow+this.nbColsVisible-k+a,f=b+a),d=this.col_offset[f]+"px",c=this.columnWidths[f]+"px",g=this.columns[p],delete this.columns[p],this.data.hasColumn(f)?
this.data.getHeader(f,function(a){g.pending=!1;return u.painter.fillColumnHeader(g,a)}):g.pending||(g.pending=!0,this.painter.fillColumnHeaderPending(g)),g.style.left=d,g.style.width=c,this.columns[f]=g,t=function(a){if(u.data.hasCell(h,f))return u.data.getCell(h,f,function(b){a.pending=!1;return u.painter.fillCell(a,b)});if(!a.pending)return a.pending=!0,u.painter.fillCellPending(a)},h=n=m,r=m+this.nb_rows_visible;m<=r?n<r:n>r;h=m<=r?++n:--n)l=h+","+p,a=this.cells[l],delete this.cells[l],this.cells[h+
","+f]=a,a.style.left=d,a.style.width=c,t(a);return this.lastVisibleRow=b}};c.prototype.moveY=function(b){var a,c,d,g,f,k,h,l,m,p,s,t,q,n,r=this;k=this.firstVisibleRow;h=this.lastVisibleRow;p=b-k;if(0!==p){d=Math.min(Math.abs(p),this.nb_rows_visible);for(a=t=0;t<d;a=t+=1)for(0<p?(l=k+a,c=b+a+this.nb_rows_visible-d):(l=k+this.nb_rows_visible-d+a,c=b+a),m=c*this.rowHeight+"px",s=function(a){if(r.data.hasCell(c,g))return r.data.getCell(c,g,function(b){a.pending=!1;return r.painter.fillCell(a,b)});if(!a.pending)return a.pending=
!0,r.painter.fillCellPending(a)},g=q=h,n=h+this.nbColsVisible;h<=n?q<n:q>n;g=h<=n?++q:--q)f=l+","+g,a=this.cells[f],delete this.cells[f],this.cells[c+","+g]=a,a.style.top=m,s(a);return this.firstVisibleRow=b}};return c}();window.fattable=function(c){return new w(c)};window.fattable.TableData=y;window.fattable.TableView=w;window.fattable.CellPainter=v}).call(this);
