...
0;f+b<c.length;)c[f+b]-c[f]>a?f+=1:b+=1;return b};H=function(){function c(){this.I=[]}c.prototype.bind=function(a,b,f){this.I.push([a,b,f]);return a.addEventListener(b,f)};c.prototype.ra=function(){var a,b,f,c,e,k;k=this.I;c=0;for(e=k.length;c<e;c++)a=k[c],f=a[0],b=a[1],a=a[2],f.removeEventListener(b,a);this.I=[]};return c}();I=function(){function c(a,b,c,g,e){var k,h,d=this;this.a=a;this.b=b;this.k=c;this.q=g;this.e=document.createElement("div");this.e.className+=" fattable-v-scrollbar";this.d=document.createElement("div");
this.d.className+=" fattable-h-scrollbar";this.a.appendChild(this.e);this.a.appendChild(this.d);a=document.createElement("div");a.style.height="1px";a.style.width=this.k+"px";b=document.createElement("div");b.style.width="1px";b.style.height=this.q+"px";this.d.appendChild(a);this.e.appendChild(b);this.Z=Math.max(this.d.offsetHeight,this.e.offsetWidth);this.e.style.bottom=this.Z+"px";this.d.style.right=this.Z+"px";this.scrollTop=this.scrollLeft=0;this.d.onscroll=function(){console.log("onhscroll");
if(!d.r&&(console.log(d.scrollLeft,d.d.scrollLeft),d.scrollLeft!==d.d.scrollLeft))return d.scrollLeft=d.d.scrollLeft,d.p(d.scrollLeft,d.scrollTop)};this.e.onscroll=function(){console.log("onvscroll");if(!d.r&&(console.log(d.scrollTop,d.e.scrollTop),d.scrollTop!==d.e.scrollTop))return d.scrollTop=d.e.scrollTop,d.p(d.scrollLeft,d.scrollTop)};e.bind(this.a,"mousedown",function(a){if(1===a.button)return d.r=!0,d.a.className="fattable-body-container fattable-moving",d.L=d.scrollLeft+a.clientX,d.ca=d.scrollTop+
a.clientY});e.bind(this.a,"mouseup",function(){d.r=!1;return d.a.className="fattable-body-container"});e.bind(this.a,"mousemove",function(a){return window.setTimeout(function(){var b,c;if(d.r)return b=-a.clientX+d.L,c=-a.clientY+d.ca,d.H(b,c)},0)});e.bind(this.a,"mouseout",function(a){if(d.r&&(null===a.toElement||a.toElement.parentElement.parentElement!==d.a))return d.a.className="fattable-body-container",d.r=!1});e.bind(this.b,"mousedown",function(a){if(1===a.button)return d.A=!0,d.b.className="fattable-header-container fattable-moving",
d.L=d.scrollLeft+a.clientX});e.bind(this.a,"mouseup",function(){d.A=!1;return d.b.className="fattable-header-container"});e.bind(this.b,"mousemove",function(a){return window.setTimeout(function(){var b;if(d.A)return b=-a.clientX+d.L,d.H(b)},0)});e.bind(this.b,"mouseout",function(a){if(d.A&&(null===a.toElement||a.toElement.parentElement.parentElement!==d.b))return d.A.className="fattable-header-container",d.A=!1});this.ha=this.k>this.d.clientWidth?this.k-this.d.clientWidth:0;this.ia=this.q>this.e.clientHeight?
this.q-this.e.clientHeight:0;h="DOMMouseScroll";void 0!==this.a.onwheel?h="wheel":void 0!==this.a.onmousewheel&&(h="mousewheel");k=function(){switch(h){case "wheel":return function(a){var b,c,d,f,e,g;switch(a.Da){case a.ta:b=null!=(d=-50*a.aa)?d:0;c=null!=(f=-50*a.ba)?f:0;break;case a.ua:b=null!=(e=-1*a.aa)?e:0,c=null!=(g=-1*a.ba)?g:0}return[b,c]};case "mousewheel":return function(a){var b,c,d;b=null!=(c=a.wheelDeltaX)?c:0;a=null!=(d=a.wheelDeltaY)?d:a.wheelDelta;return[b,a]};case "DOMMouseScroll":return function(a){var b,
c;c=b=0;a.axis===a.va?b=-50*a.detail:c=-50*a.detail;return[b,c]}}}();e.bind(this.a,h,function(a){var b;b=k(a);if(d.H(d.scrollLeft-b[0],d.scrollTop-b[1]))return a.preventDefault()});e.bind(this.b,h,function(a){var b;b=k(a);if(d.H(d.scrollLeft-b[0],d.scrollTop))return a.preventDefault()})}c.prototype.p=function(){};c.prototype.H=function(a,b){var c;c=!1;null!=a?(a=u(a,0,this.ha),this.scrollLeft!==a&&(c=!0,this.scrollLeft=a)):a=this.scrollLeft;null!=b?(b=u(b,0,this.ia),this.scrollTop!==b&&(c=!0,this.scrollTop=
b)):b=this.scrollTop;this.d.scrollLeft=a;this.e.scrollTop=b;this.p(a,b);return c};return c}();B=function(){function c(a){var b,c=this;b=a.a;if(null==b)throw"container not specified.";if("string"===typeof b)this.a=document.querySelector(b);else if("object"===typeof b)this.a=b;else throw"Container must be a string or a dom element.";this.j(a,"painter",new A);this.j(a,"autoSetup",!0);this.j(a,"model");this.j(a,"nbRows");this.j(a,"rowHeight");this.j(a,"columnWidths");this.j(a,"rowHeight");this.j(a,"headerHeight");
this.la=this.K.length;-1===(" "+this.a.className+" ").search(/\sfattable\s/)&&(this.a.className+=" fattable");this.q=this.G*this.ma;this.t=K(this.K);this.k=this.t[this.t.length-1];this.m={};this.cells={};this.S=new H;this.V();this.Ca&&C.qa(function(){return c.pa()})}c.prototype.j=function(a,b,c){if(null==a[b]){if(void 0===c)throw"Expected parameter <"+b+">";this[b]=c}else this[b]=a[b]};c.prototype.V=function(){this.sa=this.a.offsetWidth;this.fa=this.a.offsetHeight-this.F;this.f=Math.min(L(this.t,
this.sa)+2,this.K.length);this.g=(this.fa/this.G|0)+2};c.prototype.ga=function(a,b){return[u(b/this.G|0,0,this.ma-this.g),u(J(this.t,a),0,this.la-this.f)]};c.prototype.J=function(){var a;this.S.ra();null!=(a=this.ya)&&(a.p=null);this.i.J(this);this.a.innerHTML="";return this.b=this.h=null};c.prototype.pa=function(){var a,b,c,g,e,k,h,d=this;this.J();this.V();this.m={};this.cells={};this.a.innerHTML="";this.b=document.createElement("div");this.b.className+=" fattable-header-container";this.b.style.height=
this.F+"px";this.s=document.createElement("div");this.s.className="fattable-viewport";this.s.style.width=this.k+"px";this.s.style.height=this.F+"px";this.b.appendChild(this.s);this.h=document.createElement("div");this.h.className="fattable-body-container";this.h.style.top=this.F+"px";this.l=document.createElement("div");this.l.className="fattable-viewport";this.l.style.width=this.k+"px";this.l.style.height=this.q+"px";g=a=this.f;for(k=2*this.f;a<k;g=a+=1)for(c=e=this.g,h=2*this.g;e<h;c=e+=1)b=document.createElement("div"),
b.c=!1,b.style.height=this.G+"px",this.l.appendChild(b),this.cells[c+","+g]=b;a=e=this.f;for(k=2*this.f;e<k;a=e+=1)b=document.createElement("div"),b.style.height=this.F+"px",b.c=!1,this.m[a]=b,this.s.appendChild(b);this.u=this.g;this.n=this.f;this.display(0,0);this.a.appendChild(this.h);this.a.appendChild(this.b);this.h.appendChild(this.l);this.X();this.scroll=new I(this.h,this.b,this.k,this.q,this.S);return this.scroll.p=function(a,b){var e;e=d.ga(a,b);c=e[0];g=e[1];d.display(c,g);d.s.style.left=
-a+"px";d.l.style.left=-a+"px";d.l.style.top=-b+"px";clearTimeout(d.oa);d.oa=setTimeout(d.X.bind(d),200);return d.p(a,b)}};c.prototype.X=function(a){var b,c,g,e,k,h,d,m,n,l=this;null==a&&(a=!1);h=function(b){(a||b.c)&&l.o.w(e,function(a){b.c=!1;return l.i.U(b,a)})};n=[];e=d=this.n;for(m=this.n+this.f;d<m;e=d+=1)c=this.m[e],h(c),n.push(function(){var c,d,f,h=this;f=[];g=c=this.u;for(d=this.u+this.g;c<d;g=c+=1)k=g+","+e,b=this.cells[k],a||b.c?f.push(function(a){return h.o.v(g,e,function(b){a.c=!1;return h.i.N(a,
b)})}(b)):f.push(void 0);return f}.call(this));return n};c.prototype.p=function(){};c.prototype.display=function(a,b){this.b.style.display="none";this.h.style.display="none";this.ja(b);this.ka(a);this.b.style.display="";return this.h.style.display=""};c.prototype.ja=function(a){var b,c,g,e,k,h,d,m,n,l,q,r,p,s,t,w=this;n=this.u;q=a-this.n;if(0!==q){k=Math.min(Math.abs(q),this.f);for(b=p=0;p<k;b=p+=1)for(0<q?(l=this.n+b,e=a+b+this.f-k):(l=this.n+this.f-k+b,e=a+b),g=this.t[e]+"px",c=this.K[e]+"px",h=
this.m[l],delete this.m[l],this.o.W(e)?this.o.w(e,function(a){h.c=!1;return w.i.U(h,a)}):h.c||(h.c=!0,this.i.da(h)),h.style.left=g,h.style.width=c,this.m[e]=h,r=function(a){w.o.D(d,e)?w.o.v(d,e,function(b){a.c=!1;return w.i.N(a,b)}):a.c||(a.c=!0,w.i.T(a))},d=s=n,t=n+this.g;s<t;d=s+=1)m=d+","+l,b=this.cells[m],delete this.cells[m],this.cells[d+","+e]=b,b.style.left=g,b.style.width=c,r(b);this.n=a}};c.prototype.ka=function(a){var b,c,g,e,k,h,d,m,n,l,q,r,p,s,t=this;h=this.u;d=this.n;l=a-h;if(0!==l){g=
Math.min(Math.abs(l),this.g);for(b=r=0;r<g;b=r+=1)for(0<l?(m=h+b,c=a+b+this.g-g):(m=h+this.g-g+b,c=a+b),n=c*this.G+"px",q=function(a){t.o.D(c,e)?t.o.v(c,e,function(b){a.c=!1;return t.i.N(a,b)}):a.c||(a.c=!0,t.i.T(a))},e=p=d,s=d+this.f;p<s;e=p+=1)k=m+","+e,b=this.cells[k],delete this.cells[k],this.cells[c+","+e]=b,b.style.top=n,q(b);this.u=a}};return c}();D=function(c){return new B(c)};v={Aa:y,Ba:B,xa:A,wa:v,za:x,bound:u};for(E in v)x=v[E],D[E]=x;window.Ea=D}).call(this);
