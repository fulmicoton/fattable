...
c.prototype.Z=function(){return!1};c.prototype.u=function(a,b,f){null==f&&(f=function(){});return f("getCell not implemented")};c.prototype.v=function(a,b){null==b&&(b=function(){});return b("getHeader not implemented")};return c}();x=function(c){function a(){return O=a.da.constructor.apply(this,arguments)}H(a,c);a.prototype.ia=function(b,a){return b+","+a};a.prototype.ja=function(b){return"col "+b};a.prototype.D=function(){return!0};a.prototype.Z=function(){return!0};a.prototype.u=function(b,a,c){null==
c&&(c=function(){});return c(this.ia(b,a))};a.prototype.v=function(b,a){null==a&&(a=function(){});return a(this.ja(b))};return a}(y);z=function(){function c(a){this.size=null!=a?a:100;this.data={};this.C=[]}c.prototype.O=function(){return this.data.hasOwnProperty(void 0)};c.prototype.get=function(a){return this.data[a]};c.prototype.set=function(a,b){var f;f=this.C.indexOf(a);0<=f&&this.C.splice(f,1);this.C.push(a);this.C.length>=this.size&&(f=this.C.shift(),delete this.data[f]);return this.data[a]=
b};return c}();v=function(c){function a(b){null==b&&(b=100);this.Q=new z(b);this.P=new z(b);this.M={};this.A={}}H(a,c);a.prototype.v=function(b){var a=this;if(this.P.O())return cb(this.P.get(void 0)(b));if(null!=this.A[void 0])return this.A[void 0].push([b,cb]);this.A[void 0]=[[b,cb]];return this.Ha(void 0,function(c){var d,k,h,l;a.P.set(void 0,c);l=a.A[void 0];k=0;for(h=l.length;k<h;k++)d=l[k],b=d[0],d=d[1],d(c(b));return delete a.A[void 0]})};a.prototype.D=function(){return this.Q.O()};a.prototype.u=
...
(null===a.toElement||a.toElement.parentElement.parentElement!==e.a))return e.a.className="fattable-body-container",e.o=!1}),d.bind(this.b,"mousedown",function(a){if(1===a.button)return e.w=!0,e.b.className="fattable-header-container fattable-moving",e.L=e.scrollLeft+a.clientX}),d.bind(this.a,"mouseup",function(a){var b;if(1===a.button)return e.w=!1,e.b.className="fattable-header-container",a.stopPropagation(),b=function(a){a.stopPropagation();return this.removeEventListener("click",b,!0)},e.a.addEventListener("click",
b,!0)}),d.bind(this.b,"mousemove",function(a){return window.setTimeout(function(){var b;if(e.w)return b=-a.clientX+e.L,e.H(b)},0)}),d.bind(this.b,"mouseout",function(a){if(e.w){if(null===a.toElement||a.toElement.parentElement.parentElement!==e.b)e.w.className="fattable-header-container";return e.w=!1}}));this.la=this.q>this.d.clientWidth?this.q-this.d.clientWidth:0;this.ma=this.p>this.e.clientHeight?this.p-this.e.clientHeight:0;m="DOMMouseScroll";void 0!==this.a.onwheel?m="wheel":void 0!==this.a.onmousewheel&&
